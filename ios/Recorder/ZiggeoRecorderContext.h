...
@interface ZiggeoRecorderContext: NSObject<UIImagePickerControllerDelegate, UINavigationControllerDelegate, ZiggeoRecorderDelegate, ZiggeoUploadDelegate, ZiggeoAudioRecorderDelegate>
